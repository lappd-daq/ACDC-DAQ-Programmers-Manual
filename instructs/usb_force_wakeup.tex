...
\subsection{0x4 - USB Force Wakeup}\label{inst:usbforcewakeup}
...
\begin{figure}[hb!]
	\begin{center}
		\begin{bytefield}[endianness=big,bitwidth=1.1em]{32}
			...
			\bitbox{5}{\color{lightgray}\rule{\width}{\height}} & \bitbox{4}{0x4} & 
			\bitbox{4}{\color{lightgray}\rule{\width}{\height}} & \bitbox{12}{0xEFF} \\
		\end{bytefield}
...
\begin{table}[h]
	\begin{tabular}{p{0.06\textwidth}p{0.30\textwidth}p{0.64\textwidth}}
		...
		11-0  & \textbf{0xEFF} & USB wakeup value          \\ \hline
	\end{tabular}
\end{table}
